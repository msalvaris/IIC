...
# export CUDA_VISIBLE_DEVICES=3 && nohup python -m iic.scripts.segmentation.analysis.render_potsdam --model_ind 738 --net_name best.pytorch > out/gnodec4_render_738.out &
